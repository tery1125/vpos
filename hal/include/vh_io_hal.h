...
/*******************************************************************
	VIC - S5PC100
*******************************************************************/
#define vh_VIC0_BASE 			0xe4000000

#define vh_VIC0INTSELECT		(*(volatile unsigned *)(vh_VIC1_BASE + 0xc))
#define vh_VIC0INTENABLE 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x10))
#define vh_VIC0INTENCLEAR 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x14))
#define vh_VIC0SWPRIORITYMASK 	(*(volatile unsigned *)(vh_VIC1_BASE + 0x24))
#define vh_VIC0VECTADDR25 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x164))

#define vh_VIC1_BASE 			0xe4100000

#define vh_VIC1INTSELECT		(*(volatile unsigned *)(vh_VIC1_BASE + 0xc))
#define vh_VIC1INTENABLE 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x10))
#define vh_VIC1INTENCLEAR 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x14))
#define vh_VIC1SWPRIORITYMASK 	(*(volatile unsigned *)(vh_VIC1_BASE + 0x24))
#define vh_VIC1VECTADDR11 		(*(volatile unsigned *)(vh_VIC1_BASE + 0x12c))
...
/*****************************************************************
   Timer address
 *****************************************************************/
#define vh_TIMER_BASE			0xea000000
#define vh_TCFG0	 		(*(volatile unsigned *)(vh_TIMER_BASE+0x0))
#define vh_TCFG1	 		(*(volatile unsigned *)(vh_TIMER_BASE+0x4))
#define vh_TCON	 			(*(volatile unsigned *)(vh_TIMER_BASE+0x8))
#define vh_TCNTB4	 		(*(volatile unsigned *)(vh_TIMER_BASE+0x3c))
#define vh_TCNTO4	 		(*(volatile unsigned *)(vh_TIMER_BASE+0x40))
#define vh_TINT_CSTAT	 		(*(volatile unsigned *)(vh_TIMER_BASE+0x44))
